...
# 역에서 기차가 출발할 때의 사람 수는, 역에 도착하기 전 사람 수에 (b - a)을 계산해주면 된다  
list_count_people = []
a, b = map(int, input().split())
list_count_people.append(b - a)
for i in range(9):
    a, b = map(int, input().split())
    list_count_people.append(list_count_people[i] + (b - a))
print(max(list_count_people))